...
export function ReviewForm({
  ...
  return (
    <div className="mx-auto max-w-3xl py-10 sm:py-14 pb-20">
      ...
      <p className="mt-4 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800 dark:border-amber-800/40 dark:bg-amber-950/40 dark:text-amber-300">
